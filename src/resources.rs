...
impl TResources {
    pub fn new_resources(ctx: &mut Context) -> Self {
        ...
        files.insert(26, "s01.png".to_string());
        files.insert(27, "s02.png".to_string());
        files.insert(28, "s03.png".to_string());
        files.insert(29, "s04.png".to_string());
        files.insert(30, "s05.png".to_string());
        files.insert(31, "s06.png".to_string());
        files.insert(32, "s07.png".to_string());
        files.insert(33, "s08.png".to_string());
        files.insert(34, "s09.png".to_string());
        files.insert(35, "s10.png".to_string());
        files.insert(36, "s11.png".to_string());
        files.insert(37, "s12.png".to_string());
        files.insert(38, "s13.png".to_string());
        files.insert(39, "h01.png".to_string());
        files.insert(40, "h02.png".to_string());
        files.insert(41, "h03.png".to_string());
        files.insert(42, "h04.png".to_string());
        files.insert(43, "h05.png".to_string());
        files.insert(44, "h06.png".to_string());
        files.insert(45, "h07.png".to_string());
        files.insert(46, "h08.png".to_string());
        files.insert(47, "h09.png".to_string());
        files.insert(48, "h10.png".to_string());
        files.insert(49, "h11.png".to_string());
        files.insert(50, "h12.png".to_string());
        files.insert(51, "h13.png".to_string());
